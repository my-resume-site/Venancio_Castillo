...
<section id="experience" class="mx-auto max-w-6xl px-4 py-20">
  ...
  <div class="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <article data-reveal class="rounded-2xl border border-black/10 dark:border-white/10 p-6 bg-white/70 dark:bg-neutral-900/70">
      ...
      <p class="mt-2 text-sm text-neutral-700 dark:text-neutral-300">
        I’ve sat in the operator’s seat (COO), trained sales and support teams, and built
        practical tools—webpages, CRM/ERP flows, and MT4/5 EAs. I’ll listen first, design
      ...
      <div class="mt-5 flex flex-wrap gap-3">
        <a href="#contact" class="rounded-2xl bg-brand-600 px-5 py-3 text-sm font-medium text-white hover:bg-brand-500">Let’s work together</a>
