    ...
    <div class="grid md:grid-cols-2 items-center gap-8 md:gap-12">
      ...
      <div data-reveal>
        ...
        <p class="mt-3 text-neutral-600 dark:text-neutral-300">
          ...
          On the operations side, I’ve led day-to-day execution across IT, Production, HR, and Sales—owning hiring and recruitment, service development (from design through production), tool selection and implementation, data security/compliance, and building the backbone of an organization: office setup and workflows, brand assets, KPIs, SOPs, and codes of conduct.

          On the sales side, I’ve directly overseen sales operations and worked closely with a Site Director/Center leadership to hit monthly, weekly, and daily KPIs. That includes pipeline hygiene, forecasting, lead routing, enablement (scripts, objection handling, cadences), incentive design, team coaching, and live dashboards—plus the operational follow-through that turns activity into revenue. Sales has been a core part of my career from the start, and I bring that builder’s mindset to every team I support.

          Clients describe me as positive, driven, and curious. My focus is to keep you clear and creative while I turn goals into outcomes—delivering the right tools and better processes so work gets done more effectively and efficiently.

          As an entrepreneur and former Chief Operations Officer (four years), I understand what it takes to scale and why reliable day-to-day support matters. I’m currently applying the same systems mindset to forex, helping investors make their money work through disciplined processes.

          If you’re looking for an Executive Assistant/Chief of Staff who can run administration and operations—while keeping Sales on pace with its KPIs—I’d love to connect.
        </p>
