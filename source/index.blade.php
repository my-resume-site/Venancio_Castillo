...
<section id="forex" class="mx-auto max-w-6xl px-4 py-20">
  <div class="relative overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-neutral-900/70 p-6 md:p-10">
    ...
    <div class="grid md:grid-cols-2 items-center gap-8 md:gap-12">
      ...
      <!-- sticky portrait (follows on scroll) -->
      <div class="md:sticky md:top-24 self-start md:justify-self-end" data-reveal>
        <img
  ...
  <div class="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <article data-reveal class="rounded-2xl border border-black/10 dark:border-white/10 p-6 bg-white/70 dark:bg-neutral-900/70">
      ...
      <p class="mt-2 text-sm text-neutral-700 dark:text-neutral-300">
        Help entrepreneurs and small to large teams streamline operations, automate routine work, and scale with confidence. As an EA/Chief of Staff with COO experience, I manage calendars, projects, and cross-functional teams, implement the right tools and SOPs, and turn goals into measurable outcomes. I also coach new traders toward disciplined, system-first approaches to protect capital and avoid costly mistakes.
      </p>
    </article>
    ...
    <article data-reveal class="rounded-2xl border border-black/10 dark:border-white/10 p-6 bg-white/70 dark:bg-neutral-900/70">
      ...
      <p class="mt-2 text-sm text-neutral-700 dark:text-neutral-300">
        A resilient, data-driven business that grows from the ground up—clear workflows, smooth handoffs, and KPIs that Sales, IT, Production, and HR actually use. Clients feel cared for because operations run quietly and decisions are guided by metrics—not guesswork. For trading, a community of traders who stop system-hopping and commit to evidence-based strategies. Everyone has the space to do their best work.
      </p>
    </article>

    <!-- How I can help -->
    <article data-reveal class="rounded-2xl border border-black/10 dark:border-white/10 p-6 bg-white/70 dark:bg-neutral-900/70">
      <h3 class="font-semibold">Goals & How I Help</h3>
      <!-- <p class="mt-2 text-sm text-neutral-700 dark:text-neutral-300">
      ...
      <ul class="mt-3 list-disc list-inside text-sm text-neutral-700 dark:text-neutral-300 space-y-1">
        <li>Listen & assess: Understand where you are today—processes, tools, KPIs, and constraints.</li>
        <li>Plan & prioritize: Co-design improvements with clear success metrics and timelines.</li>
        <li>Tools & automation: Recommend and implement CRMs/ERPs, dashboards, and automations; build and host an internal automation stack (from localhost to production).</li>
        <li>Web & launch assets: Deliver one-pager sites and microsites; handle deployment, SOPs, training, and handoff docs.</li>
        <li>Sales enablement: Set daily/weekly/monthly KPIs, coach the team, improve pipeline hygiene, forecasting, cadences, and live dashboards—partnering closely with the Site/Center Director.</li>
        <li>Executive support: Calendar/inbox, meeting prep, vendor and contract coordination, and cross-team follow-through.</li>
        <li>Security & governance: Define access roles, protect data, and document workflows.</li>
        <li>Measure & iterate: Track results, review dashboards, and adjust based on what the numbers show.</li>
        <li>Outcome: You focus on growth and your strengths; I take care of the rest—efficiently, reliably, and data-driven.</li>
      </ul>
